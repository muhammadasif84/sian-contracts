...
contract SafeMoonLikeToken is ERC20mod, Ownable, Pausable {
    ...
    constructor(address _uniswapRouter, IWETHHolder _holder) ERC20mod("SafeMoonLikeToken", "SMLT") Ownable(msg.sender){
    ...
    function _transfer(address from, address to, uint256 amount) internal override whenNotPaused {
        ...
        console.log("WETH CONTRACT BALANCE",IERC20(wethAddress).balanceOf(address(this)));
